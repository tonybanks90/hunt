...
= 1.4.8 =
* Style improved & block support added.
...
= 1.4.4 =
* Seo Optimization & Below Footer Copyright.
...
* Th advance product search msg issue fixed.
...
= 1.2.6 =
* Style Issue Fixed.
* body font issue fixed.
* rating color issue fixed.
* pricing font size improve.
...
= 1.2.3 =
* Rtl Issue fixed.
* Enable mobile cart count in header.
* Increase category sub menu arrow width, height and add color.
